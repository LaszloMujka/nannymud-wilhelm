...
// -- Properties ---------------------------------------------------------
  ...
  add_property("forest");
  add_light(1);
  add_exit("east", "forest_p7");
  add_hidden_exit("south", "forest12", "into the forest","check_exit");
...
// -- Description and settings -------------------------------------------
  ...
  "hang between the towering trees. A river flows by to the west and the path "+
  "stops abruptly. ");    
...
check_exit() { 
     ...
     (this_player()-> query_puzzle("wilhelm_bloodwood_quest")))
  {
    ...
    // "/players/wilhelm/area/bloodwood/rooms/forest12");	  
  return;
  }	
