...
// -- Description and settings -------------------------------------------
  ...
  "grassy meadow. To the west, you can see the start of a massive forest "+
  "and to the east, the path continues along endless fields of grass. ");    
